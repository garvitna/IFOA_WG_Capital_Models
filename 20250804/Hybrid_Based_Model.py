...
inflation_class_impact = ProteusVariable.from_series(inflation_class_df["Inflation_Impact"])
...
# apply correlation between non-cat losses and reserve risk and between lobs
copulas.StudentsTCopula(correlation_matrix, corr_inputs_params["Class_DoF"]).apply(
    [*non_cat_losses_by_lob, *future_ultimate_reserves_by_lob]
)
total_uw_losses_by_lob = non_cat_losses_by_lob + aggregate_cat_losses_by_lob
...
ceded_losses_by_lob = apply_reinsurance(
    inflated_non_cat_losses_by_lob,
...
net_non_cat_losses_by_lob = inflated_non_cat_losses_by_lob - ceded_losses_by_lob["Non-Catastrophe"]
...
net_non_cat_underwriting_losses: StochasticScalar = net_non_cat_losses_by_lob.sum()
...
net_losses_by_loss_type = ProteusVariable(
    "loss_type",
    {
        "Non-Catastrophe": net_non_cat_underwriting_losses,
        "Catastrophe": net_aggregate_cat_losses,
    },
)

# calculate the total gross losses
total_gross_losses_by_lob = inflated_non_cat_losses_by_lob + inflated_aggregate_cat_losses_by_lob
