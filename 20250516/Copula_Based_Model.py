...
with pd.ExcelWriter('Copula_Based_Model_Output.xlsx') as writer:
    ...
    Spearman_Correlation_Matrix.to_excel(writer, sheet_name = "Spearman_Corr_Matrix", index=False)
    ...
    joint_exceedance_df.to_excel(writer, sheet_name = "Joint_Exceedance_Probabilities", index=False)
